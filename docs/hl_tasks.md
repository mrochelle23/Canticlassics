...
15. Create the newsletter form in HTML.
...
16. Create a route in Flask to handle newsletter functionality.
- Description: Create a Flask route to manage newsletter signup functionality.
- Expected time to complete: Completed
- Responsible: Mikhai

17. Set up a MongoDB cluster to handle user-input to sign up for the newsletter.
- Description: Set up a MongoDB cluster to store newsletter signups.
- Expected time to complete: Completed
- Responsible: Mikhai

18. Write the first half of the unit test script
...
6. Write the second half of the unit test script
- Description: Write unit tests in python
- Expected time to complete: Completed
- Responsible: Kyle
